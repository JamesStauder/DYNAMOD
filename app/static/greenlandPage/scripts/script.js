    ...
    tileLayers.push(new ol.layer.Tile({
        ...
        source: new ol.source.TileImage({
            tileUrlFunction: function(tileCoord, pixelRatio, projection) {
                ...
                var x = tileCoord[1];
                var y = -tileCoord[2] - 1;
                return staticURL + "tilesGreenland/" + currentMap + "/" + z + "_" + x + "_" + y + ".png";
...
//Conversion functions have hard coded values. These would need to change if backend dataset changes. This is done here to preserve server calls
//These numbers do not exactly line up with data on backend as our tiles got extended to fit a square div. xMax is xMax of TILES not data
...
$("#point-lookup").on("click", function() {
    ...
    $.ajax({
        ...
        error: function(d){
            alert("Point not found. Please enter a valid lat/long within Greenland");
        },
        failure: function(d) {
            alert("AJAX FAILED!");
        }
